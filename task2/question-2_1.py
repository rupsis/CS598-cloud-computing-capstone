...
# bin/spark-submit --jars external/lib/spark-streaming-kafka-0-10-assembly.jar  --executor-memory 20G --master yarn --num-executors 50  ~/test/test.py 
# bin/spark-submit --packages org.apache.spark:spark-sql-kafka-0-10_2.11:2.2.1  --executor-memory 20G --master yarn --num-executors 50  ~/test/test.py 
